...
- Dirigido a `dsh 0.1.5-alpha.1` (perfil web, formato de sesión V3); las dependencias peer requieren `>=0.1.2-rc.1 <0.2.0 || >=0.1.5-alpha.1 <0.2.0`. Verificado contra `dsh-v0.1.5-alpha.1` el 2026-09-09. Node `^22.19 || >=24`.
