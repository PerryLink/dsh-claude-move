...
- एकमात्र अपवाद: **पहले से खुला वेब पृष्ठ** नई सत्र पंक्तियाँ दिखाने से पहले सत्र सूची को एक बार ताज़ा करना चाहिए — आयात सीधे पर्सिस्टेंस सेवा में cold सत्र लिखता है, इसलिए लाइव `host/session-added` फ़्रेम नहीं जाता; वर्कस्पेस समूह लाइव अपडेट होते हैं (`host/workspace-changed`)। पैनल का «सत्र सूची ताज़ा करें» बटन दबाएँ (या पृष्ठ रीलोड करें) — सर्वर रीस्टार्ट की ज़रूरत नहीं।
- आयातित सत्र तुरंत खोले, पढ़े और जारी किए जा सकते हैं — `/resume-claude`, या ताज़ा करने के बाद सूची में सत्र पर क्लिक करें। कभी भी दोबारा आयात चलाने पर केवल नए टर्न उन्हीं सत्रों में जुड़ते हैं।
...
- id: claude-move
  ...
  config:
    ...
    scanGit: true               # git ब्रांच व गंदी स्थिति जाँचें
...
- अंतिम सत्यापन **2026-08-13** विंडोज़ (Node 22) पर `@deepseek-ai/dsh@0.1.0-rc.6` के विरुद्ध: tarball से शून्य-से इंस्टॉल, वास्तविक स्कैन (40 प्रोजेक्ट / 2387 सत्र), वास्तविक बैच आयात 13/13 + आइडेम्पोटेंट पुनः-आयात 13/13, वर्कस्पेस जुड़ाव व पर्सिस्टेंस आर्टिफ़ैक्ट पुष्ट। macOS/Linux शेष।
...
- `maxTranscriptBytes` से बड़ी ट्रांसक्रिप्ट आंशिक आयात की बजाय ज़ोर से विफल होती हैं (विश्वसनीयता पहले); स्ट्रीमिंग खंड-आयात रोडमैप पर है।
