...
- `dsh 0.1.5-alpha.1` (web profile, सत्र प्रारूप V3) को लक्षित करता है; peer निर्भरताएँ `>=0.1.2-rc.1 <0.2.0 || >=0.1.5-alpha.1 <0.2.0` चाहिए। 2026-09-09 को `dsh-v0.1.5-alpha.1` के विरुद्ध सत्यापित। Node `^22.19 || >=24`।
