...
- 目标：`dsh 0.1.5-alpha.1`（web profile，会话格式 V3）；peerDeps 范围 `>=0.1.2-rc.1 <0.2.0 || >=0.1.5-alpha.1 <0.2.0`；纯 ESM 无构建（git/npm/tarball 三种安装均免 `prepare`/`allowBuilds`）。
