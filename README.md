...
- Targets `dsh 0.1.5-alpha.1` (web profile, session format V3); peer dependencies require `>=0.1.2-rc.1 <0.2.0 || >=0.1.5-alpha.1 <0.2.0`. Verified against `dsh-v0.1.5-alpha.1` on 2026-09-09. Node `^22.19 || >=24`.
