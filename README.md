...
> Status: in development (Phase 3/6 — personal context migration done). Roadmap and design: [PLAN.md](PLAN.md).
...
- The Web panel and `/resume-claude` command are not implemented yet (Phases 4/5).
