 ...
 * @param {any} converted - convertClaudeJsonl 输出。
 * @param {object} [options] - 选项。
 * @param {number} [options.maxChars] - 摘要字符上限。
 * @param {string} [options.title] - 源会话标题。
 * @param {string|null} [options.sourceCwd] - 源 Claude 项目目录。
 * @param {string|null} [options.workspaceCwd] - claudecode 模式下会话实际所在目录。
 * @returns {string} 摘要文本。
 */
