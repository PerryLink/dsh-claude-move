...
- `dsh 0.1.7-rc.1` (web profile, वर्तमान लाइन पर सत्र प्रारूप V4) को लक्षित करता है; peer निर्भरताएँ `>=0.1.2-rc.1 <0.2.0 || >=0.1.5-alpha.1 <0.2.0 || >=0.1.6-0 <0.2.0 || >=0.1.7-0 <0.2.0` चाहिए। 2026-09-24 को सत्यापित (checkJs प्रकार गेट + 291 असर्शन, 38 सूट)। आयातित लॉग वर्तमान पुनर्स्थापन सीमा को फिर से पूरा करते हैं: `tool/result` V4 के प्रथम-श्रेणी tool रोल संदेश के रूप में लिखा जाता है, और रिज़्यूम हैंडऑफ़ उत्पादक-स्वामित्व वाला संदेश स्रोत kind (`dsh-claude-move`) लेकर चलता है, क्योंकि 0.1.7-alpha.1 ने सामान्य `{ kind: 'plugin', plugin }` स्रोत को प्रकार-परत और टिकाऊ-पंक्ति प्रवेश, दोनों से हटा दिया। जब होस्ट `sessions.open()` नहीं देता, पैनल का "सत्र खोलें" बटन विवरणी title के साथ निष्क्रिय रूप में प्रस्तुत होता है। Node `^22.19 || >=24`।
